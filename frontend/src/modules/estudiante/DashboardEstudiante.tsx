...
const STATUS_MAP: Record<string, { variant: 'default' | 'success' | 'warning' | 'danger' | 'info' | 'neutral'; label: string }> = {
  ...
  INFORME_EN_REVISION: { variant: 'info', label: 'Informe en Revisión' },
  INFORME_APROBADO: { variant: 'success', label: 'Informe Aprobado' },
  EVALUACION_EMPRESA_PENDIENTE: { variant: 'warning', label: 'Evaluación de Empresa Pendiente' },
  EVALUACION_PENDIENTE: { variant: 'warning', label: 'Evaluación Pendiente' },
  EVALUACION_COMPLETA: { variant: 'info', label: 'Evaluación Completa' },
